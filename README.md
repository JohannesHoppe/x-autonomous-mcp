...
>
> What are you paying for? Since February 2026, X offers a [pay-per-use model](https://devcommunity.x.com/t/announcing-the-launch-of-x-api-pay-per-use-pricing/256476) alongside the old tiers ($200/month Basic, $5,000/month Pro). You buy credits upfront — $0.005 per post read, $0.01 per post write, $0.015 per like/follow. Sounds reasonable until you realize **you can't actually use the write endpoints for anything meaningful.** You're paying per API call to search tweets, read them, and like them. That's it. You cannot reply to anyone. You cannot quote-tweet anyone. You cannot @mention anyone. Every "engagement" endpoint returns 403 unless the target already knows you exist. The old Free tier is a joke — likes and follows were [removed from it in August 2025](https://techcrunch.com/2025/08/22/x-pulls-the-ability-to-like-and-follow-from-its-developer-apis-free-tier/). Enterprise (~$42,000+/year) is exempt from all restrictions — because of course it is.
>
